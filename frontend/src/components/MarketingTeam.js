  ...
  return (
    <Container className="marketing-section">
      <div className="marketing-grid">
        ...
        <div className="marketing-card">
          <div className="marketing-card__body">
            <img className="marketing-avatar" src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&amp;w=200" alt="userImage4" />
            <h2 className="marketing-name">Sarah Bennett</h2>
            <p className="marketing-role">Social Media</p>
            <p className="marketing-badge">Admin</p>
          </div>
          <div className="marketing-card__actions">
            <button type="button" className="marketing-action">
