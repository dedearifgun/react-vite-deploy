  ...
  return (
    <footer className="site-footer">
      ...
      <div className="footer-socials">
        ...
        <a href="https://www.instagram.com/narpati_leather" target="https://www.instagram.com/narpati_leather" rel="noopener noreferrer" aria-label="Instagram" className="social-link">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="social-link">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
